...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let ship = nodeFromResource(assetName: "assets/Dancing Twerk", extensionName: "dae")
        ship.position = SCNVector3Make(0, -5, 0);
        ship.scale = SCNVector3(0.05, 0.05, 0.05);
        
        scene.rootNode.addChildNode(ship)
        
//        let animation = animationFromSceneNamed(path: "art.scnassets/shipFolder/Maya_ThirdPersonIdle_animation.dae")
//        ship.addAnimation(animation!, forKey: "anim")
//
